...
diene_dienophile_substract <- c("HOMO_diene_dienophile", "LUMO_diene_dienophile", "GAP_diene_dienophile")
dienophile_diene_substract <- dienophile - diene
dienophile_diene_substract <- c("HOMO_dienophile_diene", "LUMO_dienophile_diene", "GAP_dienophile_diene")
...
combine <- cbind(diene_dienophile_substract, dienophile_diene_substract, 
                 dieneXdienophile, diene_dienophile)
...
Product <- diene$Product
Product <- as.factor(Product)
plot <- ggplot(data.frame(Product),aes(x=Product))
plot <- plot + geom_histogram(fill = "blue")
print(plot)
```
